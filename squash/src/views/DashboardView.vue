...
import WeatherHour from '@/components/Dashboard/WeatherHour.vue';
...
console.log('selectedhourly', selectedHourly.value)
</script>
  ...
  <main>
    <div class="dashboard">
        <!-- <div class="welcome">
            ...
            <br />
            <br />
            It is currently {{ dayjs().format('HH:mm [on] dddd, MMMM Do') }}.
        </div> -->
        <Card>
            <template #title>
            ...
            <template #content>
              ...
              <div class="current">
                <div class="conditions">
                    <span class="temperature">{{ store.weather.current?.temperature_2m }}°</span>
                ...
                <div class="additional-data">
                        <div class="feels-like">Feels like {{ store.weather.current?.apparent_temperature }}°</div>
